/**
 * @file publish.go
 * @brief Publikace NDIC sdtype, instancí a datových bodů do RabbitMQ front RIoT.
 *
 ...
 * - Vojtěch Hubáček: doplnění registrace instancí, tag/field parametrů, EventTime a nulových zpráv pro neaktivní segmenty.
 */
package main
